...
function ChoixVehicule() {
  ...
  <summary className="m-1 btn bg-blue text-almostWhite text-xl hover:bg-brown">Filtres et tri</summary>
  <div className="p-2 shadow menu dropdown-content z-[1] bg-blue rounded-box w-52 h-96 overflow-scroll">
        ...
        <div className="w-1/6 text-almostWhite  m-5">
          ...
          <div>
            ...
            <button value="2" className={`w-28 rounded-lg font-mono text-lg p-2 m-2  border border-blue hover:bg-brown hover:scale-105 hover:text-almostWhite active:scale-75 
              ${roues === 2 ? "bg-brown " :"bg-almostWhite text-blue"}
              `} onClick={handleRoues}>
              2 roues
            </button>
            <button value="4" className={`w-28 rounded-lg font-mono text-lg p-2 m-2  border border-blue hover:bg-brown hover:scale-105 hover:text-almostWhite active:scale-75 
          ...
          <div>
            ...
            <button value="Royal" className={`w-28 rounded-lg font-mono text-lg p-2 m-2  border border-blue hover:bg-brown hover:scale-105 hover:text-almostWhite active:scale-75 
              ${confort === "Royal" ? "bg-brown " :"bg-almostWhite text-blue"}
              `} onClick={handleConfort}>
              Royal
            </button>
            <button value="Noble" className={`w-28 rounded-lg font-mono text-lg p-2 m-2  border border-blue hover:bg-brown hover:scale-105 hover:text-almostWhite active:scale-75 
              ${confort === "Noble" ? "bg-brown " :"bg-almostWhite text-blue"}
              `} onClick={handleConfort}>
              Noble
            </button>
            <button value="Serf" className={`w-28 rounded-lg font-mono text-lg p-2 m-2  border border-blue hover:bg-brown hover:scale-105 hover:text-almostWhite active:scale-75 
